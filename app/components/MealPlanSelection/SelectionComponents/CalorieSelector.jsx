...
import { setCaloriesPerDay } from "../../../../lib/slices/caloriesPerDaySlice";
...
export default function NumberInputBasic() {
  ...
  const handleChange = (event, val) => {
    dispatch(setCaloriesPerDay(val));
  };
  return (
    <NumberInput
      ...
      slotProps={{
        root: (ownerState) => {
          ...
          return {
            ...resolvedSlotProps,
            className: clsx(
              'grid grid-cols-[1fr_8px] grid-rows-2 overflow-hidden font-sans rounded-lg text-slate-900 dark:text-slate-300 border border-solid  bg-white dark:bg-slate-900  hover:border-slate-700 dark:hover:border-slate-700 focus-visible:outline-0 p-1',
              ownerState.focused
                ? 'border-slate-400 dark:border-slate-400 shadow-lg shadow-outline-purple dark:shadow-outline-purple'
                : 'border-slate-400 dark:border-slate-600 shadow-md shadow-slate-100 dark:shadow-slate-900',
